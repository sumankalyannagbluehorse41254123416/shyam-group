...
export default function Features() {
  ...
  {[
    ...
    <div
      key={feature.title}
      className={`
        bg-white p-3 md:p-6 rounded-lg shadow-md text-center hover-scale animate-on-scroll zoom-in delay-${(index + 1) * 100}
        ${index === 2 ? 'col-span-2 md:col-span-1' : ''}
      `}
    >
      <div className="bg-red-100 bg-opacity-10 w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-4">
        {feature.icon}
      </div>
